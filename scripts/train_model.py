...
def main(cfg):
    ...
    # Setup logging
    setup_logging(
        log_level="DEBUG" if cfg.general.verbose else "INFO", console_output=True
    )
    ...
    try:
        ...
        if init_from_pipeline_dir:
            ...
            trainer.setup_model(
                dataset=dataset, text_encoder=dataset_loader.text_encoder
            )
        ...
        trainer.train(dataloaders, save_path=cfg.general.output_path)
