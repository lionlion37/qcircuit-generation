...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../src/training/config_model.ipynb.

# %% auto 0
__all__ = ['ConfigModel']

# %% ../../src/training/config_model.ipynb 2
from ..imports import *
from ..utils.config_loader import *
from ..utils.misc_utils import *
from datetime import datetime

# %% ../../src/training/config_model.ipynb 4
class ConfigModel(nn.Module):
    ...
    def from_config(config, device: torch.device, save_path: str=None, verbose=True, silent=False, freeze: Optional[bool] = None):  
        """Use this if we have a loaded config. Maybe within other classes (e.g. pipeline and nested training)"""
