...
class ConfigManager:
    ...
    def get_preset_config(self, preset_name: str, config_type: str) -> Dict[str, Any]:
        ...
        preset_configs = {
            ...
            "evaluation": {
                "comprehensive": {
                    ...
                    "generation": {"num_samples": 100, "num_inference_steps": 50},
                    "output": {"save_results": True, "create_plots": True},
                },
                "basic": {
                    "metrics": {
                        "circuit_properties": True,
                    ...
                    "generation": {"num_samples": 50},
                    "output": {"save_results": True, "create_plots": False},
                },
            },
        }
        ...
        if preset_name not in preset_configs[config_type]:
            raise ValueError(
                f"Unknown preset '{preset_name}' for config type '{config_type}'"
            )
    ...
    def create_experiment_config(
        self, base_config: Dict, experiment_params: Dict
    ) -> Dict:
    ...
    def _create_example_configs(self) -> None:
        ...
        evaluation_config = {
            ...
            "comparison": {"compare_to_training": True, "compare_to_random": True},
            "output": {"save_results": True, "create_plots": True, "verbose": True},
        }
